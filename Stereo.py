...
ImT1_L = cv2.imread('C:/Users/Benjamin/Desktop/Fakultet/Master/II semestar/RV/Projekat/00/image_0/000000.png', 0)  # 0 flag returns a grayscale image
ImT1_R = cv2.imread('C:/Users/Benjamin/Desktop/Fakultet/Master/II semestar/RV/Projekat/00/image_1/000000.png', 0)

ImT2_L = cv2.imread('C:/Users/Benjamin/Desktop/Fakultet/Master/II semestar/RV/Projekat/00/image_0/000001.png', 0)
ImT2_R = cv2.imread('C:/Users/Benjamin/Desktop/Fakultet/Master/II semestar/RV/Projekat/00/image_0/000001.png', 0)
...
print( "Threshold: {}".format(fastFeatureEngine.getThreshold()) )
print( "nonmaxSuppression:{}".format(fastFeatureEngine.getNonmaxSuppression()) )
print( "neighborhood: {}".format(fastFeatureEngine.getType()) )
print( "Total Keypoints with nonmaxSuppression: {}".format(len(ftDebug)) )
